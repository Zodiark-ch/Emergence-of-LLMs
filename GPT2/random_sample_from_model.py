...
from transformers import AutoTokenizer, GPT2LMHeadModel,OpenAIGPTModel,OpenAIGPTTokenizer,GPTNeoXForCausalLM,GPTNeoXConfig,AutoModelForCausalLM
...
class Sample_from_GEMMA7B(nn.Module):
    def __init__(self,args):
        super().__init__()
        self.args=args
        self.model_name=args.model_name
    ...
    def forward(self,past_key_values = None,cache_position= None,position_ids = None,):
        ...
        for s in trange(self.sample_size):
            ...
            for decoder_layer in self.layers:
                ...
                x_sample = self.gen_x(batch_size,self.token_num, 3072, 0.81)
